...
const Footer = () => {
  return (
    <footer className="bg-zinc-50 text-zinc-700 pt-14 sm:pt-20 pb-10 sm:pb-12 px-4 sm:px-6 border-t border-zinc-200">
          ...
          <ul className="space-y-2 text-xs sm:text-sm">
            ...
            <li className="pt-2 flex flex-col gap-2">
              <a 
                ...
                className="flex items-center gap-2 text-zinc-700 hover:text-emerald-700 transition-colors text-xs sm:text-sm font-bold"
              >
      ...
      <div className="container-custom pt-6 sm:pt-8 border-t border-zinc-200 flex flex-col sm:flex-row items-center justify-between gap-3 text-[11px] sm:text-xs text-zinc-500 mono text-center sm:text-left">
