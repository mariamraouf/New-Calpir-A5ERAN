    ...
    <div className="border border-zinc-200 bg-white p-4 sm:p-6 md:p-10 shadow-lg">
      ...
      {step === 3 && (
        <div className="text-center py-8 sm:py-12 space-y-4 sm:space-y-5 animate-in zoom-in-95">
          <div className="w-14 h-14 sm:w-16 sm:h-16 bg-emerald-100 text-emerald-700 rounded-full flex items-center justify-center<dyad-write path="src/components/booking/BookingSystem.tsx" description="Complete BookingSystem component with step 3 and responsive styles">
"use client";
