...
const ServiceDetail = () => {
  ...
  const servicesData: Record<string, any> = {
    ...
    'marketing-branding': {
      ...
      get: "Live marketing platforms<dyad-write path="src/pages/ServiceDetail.tsx" description="Complete ServiceDetail with per-module dynamic title, description, and canonical tags">
"use client";
