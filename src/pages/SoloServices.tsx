 ...
 *
 * Prices are shown in the currency the visitor picks, because we sell into the
 * US, the UK and the EU and making someone convert in their head is a small tax
 * on buying.
 */
const SoloServices = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <MetaSEO
        ...
        description="Every Calpir service with its price, from domain setup and CRM to recruiting, payroll and AI agents. You pay for what you see."
        path="/solo-services"
      />
      <Navbar />
