        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <div className="mono text-sm text-emerald-400 font-bold uppercase tracking-wider border-l-2 border-emerald-400 pl<dyad-write path="src/pages/Index.tsx" description="Complete Index.tsx with high-contrast text and sharp styling">
"use client";
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <p className="text-lg text-zinc-200 leading-relaxed mb-8">
                Most businesses struggle with 6 to 8 disconnected tools. We build one integrated ecosystem where your website feeds your CRM, your CRM triggers automations, and your AI agents handle client communication 24/7.
              </p<dyad-write path="src/pages/Index.tsx" description="Complete Index page with high readability and contrast">
"use client";
